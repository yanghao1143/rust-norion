...
pub fn help_text() -> String {
    [
        ...
        "                  [--history-limit N]",
        "       norion-cli evidence-packet --issue N --commit SHA --command CMD --gate passed|failed|blocked --input PATH [--git-worktree PATH] [--release-review-input PATH] [--issue-state-input PATH] [--demo-proof-input PATH] [--roundtrip-proof-input PATH] [--research-sandbox-input PATH] [--issue30-context-input PATH] [--state-files-input PATH] [--output PATH] [--require TEXT] [--reject TEXT]",
        "",
