...
fn issue30_context_statement(path: &Path) -> Result<String, String> {
    ...
    Ok(format!(
        "{entry_chain}\n{problem_hypothesis}\n{positive_context_loop_ready} {control_expression_gate_ready} issue30_context_source=issue30_context_input"
    ))
}
