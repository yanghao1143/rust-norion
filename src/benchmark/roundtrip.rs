...
use crate::development_pollution::{
    ...
    DevelopmentEvidenceUseSurface, DevelopmentPollutionEvent, DevelopmentPollutionFinding,
...
use crate::reasoning_genome::{
    ...
    GeneScissorsOperatorDecision, GenomeExpressionInput, ReasoningFrame, ReasoningGene,
    ReasoningGeneKind, ReasoningGenome, default_issue379_primitive_decision,
};
...
pub struct PersistentRoundtripInput {
    ...
    pub second_planning_dense_compute_avoided_tokens: usize,
...
struct Issue377ProblemHypothesisPreview {
    ...
    self_observation_id: String,
    self_observation_schema: &'static str,
    self_observation_signal_source: &'static str,
    self_observation_source_digest: String,
    self_observation_window: &'static str,
    self_observation_current_truth_digest: String,
    self_observation_digest_only: bool,
    self_observation_raw_payload_present: bool,
    self_observation_write_allowed: bool,
    self_observation_applied: bool,
    self_model_present: bool,
    self_model_id: String,
    self_model_schema: &'static str,
    self_model_scope: &'static str,
    self_model_claims_consciousness: bool,
    self_model_digest_only: bool,
    self_model_raw_payload_present: bool,
    self_model_write_allowed: bool,
    self_model_applied: bool,
    hypothesis_candidate_id: String,
    hypothesis_candidate_kind: &'static str,
    hypothesis_candidate_status: &'static str,
    hypothesis_candidate_target_surface: &'static str,
    hypothesis_candidate_expected_metric: &'static str,
    hypothesis_candidate_expected_direction: &'static str,
    hypothesis_candidate_required_gates: &'static str,
    hypothesis_candidate_rollback_anchor: String,
    hypothesis_candidate_raw_payload_present: bool,
    hypothesis_candidate_write_allowed: bool,
    hypothesis_candidate_applied: bool,
    hypothesis_candidate_operator_approval_required: bool,
    ...
    risk_override_action: &'static str,
    negative_evidence_count: usize,
    privacy_risk: &'static str,
    license_risk: &'static str,
    unsupported_capability_requested: bool,
    unsafe_side_effect_allowed: bool,
    risk_override_clear: bool,
    ...
    experiment_plan_level_path: &'static str,
    validation_skipped_levels: &'static str,
    validation_skipped_reason: &'static str,
    human_apply_level: &'static str,
    human_apply_inside_engine: bool,
    validation_level_apply_allowed: bool,
    experiment_plan_required_gates: &'static str,
    experiment_plan_budget_tokens: usize,
    experiment_plan_stop_on_fail: bool,
    experiment_plan_rollback_anchor: String,
    experiment_plan_raw_payload_present: bool,
    experiment_plan_write_allowed: bool,
    experiment_plan_applied: bool,
    evidence_bundle_id: String,
    evidence_bundle_schema: &'static str,
    evidence_bundle_metric: &'static str,
    evidence_bundle_direction: &'static str,
    evidence_bundle_pass_count: usize,
    evidence_bundle_fail_count: usize,
    evidence_bundle_command_label: &'static str,
    evidence_bundle_refs_digest_only: bool,
    evidence_bundle_raw_payload_present: bool,
    evidence_bundle_write_allowed: bool,
    evidence_bundle_applied: bool,
    experiment_decision: &'static str,
    experiment_decision_schema: &'static str,
    experiment_decision_reason: &'static str,
    experiment_decision_evidence_bundle_id: String,
    experiment_decision_target: &'static str,
    experiment_decision_manual_approval_required: bool,
    experiment_decision_apply_allowed: bool,
    ...
    candidate_emitter_lane_coverage: &'static str,
    candidate_emitter_kind_coverage: &'static str,
    candidate_emitter_coverage_count: usize,
    candidate_emitter_all_preview_only: bool,
    candidate_emitter_all_write_allowed: bool,
    candidate_emitter_all_apply_allowed: bool,
    candidate_emitter_all_manual_review_required: bool,
    candidate_emitter_durable_preflight_owner: &'static str,
    candidate_emitter_writer_gate_bypass_allowed: bool,
    candidate_emitter_direct_durable_write_allowed: bool,
    candidate_emitter_ready_for_explicit_apply: bool,
    related_issue_refs: &'static str,
    related_issue_scope_map: &'static str,
    related_issue_owner_scope: &'static str,
    related_issue_non_duplicate_count: usize,
    related_issue_all_non_duplicate: bool,
    related_issue_apply_allowed: bool,
    clean_room_reference_mode: &'static str,
    external_code_copied: bool,
    external_prompt_or_schema_copied: bool,
    restricted_license_material_copied: bool,
    license_provenance_posture: &'static str,
    clean_room_apply_allowed: bool,
...
impl Issue377ProblemHypothesisPreview {
    fn from_predicament(predicament: Issue377PredicamentSignal) -> Self {
        ...
        let hypothesis_candidate_rollback_anchor = stable_redaction_digest([
            "issue-377",
            "hypothesis-candidate-rollback-anchor",
            hypothesis_candidate_id.as_str(),
        ...
        let self_observation_id = stable_redaction_digest([
            "issue-377",
            "self-observation",
            "runtime-trace-metrics",
            predicament_key.as_str(),
        ]);
        let self_observation_current_truth_digest = stable_redaction_digest([
            "issue-377",
            "self-observation-current-truth",
            problem_finding_source_digest.as_str(),
            predicament_key.as_str(),
        ]);
        let self_model_id = stable_redaction_digest([
            "issue-377",
            "control-plane-self-model",
            self_observation_id.as_str(),
            problem_finding_source_digest.as_str(),
        ]);
        ...
        let experiment_plan_rollback_anchor = hypothesis_candidate_rollback_anchor.clone();
        ...
        let experiment_decision_evidence_bundle_id = evidence_bundle_id.clone();
        ...
        Self {
            ...
            problem_finding_source_digest: problem_finding_source_digest.clone(),
            ...
            self_observation_id,
            self_observation_schema: "self_observation_v1",
            self_observation_signal_source: "runtime_trace_metrics",
            self_observation_source_digest: problem_finding_source_digest,
            self_observation_window: "second_task_roundtrip",
            self_observation_current_truth_digest,
            self_observation_digest_only: true,
            self_observation_raw_payload_present: false,
            self_observation_write_allowed: false,
            self_observation_applied: false,
            self_model_present: true,
            self_model_id,
            self_model_schema: "control_plane_self_model_v1",
            self_model_scope: "auditable_control_plane",
            self_model_claims_consciousness: false,
            self_model_digest_only: true,
            self_model_raw_payload_present: false,
            self_model_write_allowed: false,
            self_model_applied: false,
            hypothesis_candidate_id,
            hypothesis_candidate_kind: "gene",
            hypothesis_candidate_status: "promoted_for_approval",
            hypothesis_candidate_target_surface: "reasoning_gene",
            hypothesis_candidate_expected_metric: "memory_reuse",
            hypothesis_candidate_expected_direction: "increase",
            hypothesis_candidate_required_gates: "trace_schema_gate|focused_tests|benchmark_gate",
            hypothesis_candidate_rollback_anchor,
            hypothesis_candidate_raw_payload_present: false,
            hypothesis_candidate_write_allowed: false,
            hypothesis_candidate_applied: false,
            hypothesis_candidate_operator_approval_required: true,
            ...
            risk_override_action: "hold",
            negative_evidence_count: 0,
            privacy_risk: "low",
            license_risk: "low",
            unsupported_capability_requested: false,
            unsafe_side_effect_allowed: false,
            risk_override_clear: true,
            ...
            validation_skipped_levels: "L2_replay|L4_integration_readiness|L5_promotion_window",
            validation_skipped_reason: "minimal_existing_evidence_path",
            human_apply_level: "L6_human_apply",
            human_apply_inside_engine: false,
            validation_level_apply_allowed: false,
            experiment_plan_required_gates: "trace_schema_gate|focused_tests|benchmark_gate",
            experiment_plan_budget_tokens: 2048,
            experiment_plan_stop_on_fail: true,
            experiment_plan_rollback_anchor,
            experiment_plan_raw_payload_present: false,
            experiment_plan_write_allowed: false,
            experiment_plan_applied: false,
            evidence_bundle_id,
            evidence_bundle_schema: "evidence_bundle_v1",
            evidence_bundle_metric: "memory_reuse",
            evidence_bundle_direction: "increase",
            evidence_bundle_pass_count: 3,
            evidence_bundle_fail_count: 0,
            evidence_bundle_command_label: "issue30_fresh_checkout_smoke",
            evidence_bundle_refs_digest_only: true,
            evidence_bundle_raw_payload_present: false,
            evidence_bundle_write_allowed: false,
            evidence_bundle_applied: false,
            experiment_decision: "promote_for_approval",
            experiment_decision_schema: "experiment_decision_v1",
            experiment_decision_reason: "clean_evidence_bundle_promotes_preview",
            experiment_decision_evidence_bundle_id,
            experiment_decision_target: "mutation_candidate_emitter",
            experiment_decision_manual_approval_required: true,
            experiment_decision_apply_allowed: false,
            ...
            candidate_emitter_lane_coverage: "reasoning_genome_preview|memory_admission_preview|routing_policy_preview|tool_policy_preview|evolution_goal_preview",
            candidate_emitter_kind_coverage: "mutation_plan_preview|memory_admission_preview|routing_shadow_proposal|tool_policy_candidate|evolution_goal_preview",
            candidate_emitter_coverage_count: 5,
            candidate_emitter_all_preview_only: true,
            candidate_emitter_all_write_allowed: false,
            candidate_emitter_all_apply_allowed: false,
            candidate_emitter_all_manual_review_required: true,
            candidate_emitter_durable_preflight_owner: "unified_writer_gate",
            candidate_emitter_writer_gate_bypass_allowed: false,
            candidate_emitter_direct_durable_write_allowed: false,
            candidate_emitter_ready_for_explicit_apply: false,
            related_issue_refs: "#6|#7|#74|#79|#375",
            related_issue_scope_map: "#6:experiment_gates|#7:memory_admission_pipeline|#74:thinking_scheduler|#79:evolution_goal_queue|#375:pre_reasoning_genome_isa",
            related_issue_owner_scope: "meta_cognitive_evolution_loop",
            related_issue_non_duplicate_count: 5,
            related_issue_all_non_duplicate: true,
            related_issue_apply_allowed: false,
            clean_room_reference_mode: "rust_norion_terms_only",
            external_code_copied: false,
            external_prompt_or_schema_copied: false,
            restricted_license_material_copied: false,
            license_provenance_posture: "project_owned_digest_only",
            clean_room_apply_allowed: false,
    ...
    fn issue30_evidence_fields(&self) -> String {
        format!(
            "issue377_problem_finding_present=true issue377_problem_finding_id={} issue377_problem_finding_kind={} issue377_problem_finding_severity={} issue377_problem_finding_confidence_milli={} issue377_problem_finding_evidence_digest={} issue377_problem_finding_source_digest={} issue377_problem_finding_affected_surface={} issue377_problem_finding_next_step={} issue377_problem_finding_raw_payload_present={} issue377_self_observation_present=true issue377_self_observation_id={} issue377_self_observation_schema={} issue377_self_observation_signal_source={} issue377_self_observation_source_digest={} issue377_self_observation_window={} issue377_self_observation_current_truth_digest={} issue377_self_observation_digest_only={} issue377_self_observation_raw_payload_present={} issue377_self_observation_write_allowed={} issue377_self_observation_applied={} issue377_self_model_present={} issue377_self_model_id={} issue377_self_model_schema={} issue377_self_model_scope={} issue377_self_model_claims_consciousness={} issue377_self_model_digest_only={} issue377_self_model_raw_payload_present={} issue377_self_model_write_allowed={} issue377_self_model_applied={} issue377_hypothesis_candidate_present=true issue377_hypothesis_candidate_id={} issue377_hypothesis_candidate_kind={} issue377_hypothesis_candidate_status={} issue377_hypothesis_candidate_target_surface={} issue377_hypothesis_candidate_expected_metric={} issue377_hypothesis_candidate_expected_direction={} issue377_hypothesis_candidate_required_gates={} issue377_hypothesis_candidate_rollback_anchor={} issue377_hypothesis_candidate_raw_payload_present={} issue377_hypothesis_candidate_write_allowed={} issue377_hypothesis_candidate_applied={} issue377_hypothesis_candidate_operator_approval_required={} issue377_problem_hypothesis_link={} issue377_admission_decision={} issue377_lexicographic_admission_present={} issue377_lexicographic_admission_order={} issue377_user_intent_preserved={} issue377_safety_gate_passed={} issue377_digest_only_evidence_gate_passed={} issue377_rollback_anchor_gate_passed={} issue377_quality_delta_milli={} issue377_cost_delta_milli={} issue377_latency_delta_milli={} issue377_performance_tiebreaker_only={} issue377_hard_gate_failure_action={} issue377_risk_override_action={} issue377_negative_evidence_count={} issue377_privacy_risk={} issue377_license_risk={} issue377_unsupported_capability_requested={} issue377_unsafe_side_effect_allowed={} issue377_risk_override_clear={} issue377_lexicographic_admission_apply_allowed={} issue377_best_next_state={} issue377_best_next_state_id={} issue377_best_next_state_selected={} issue377_predicament_signal_present=true issue377_predicament_id={} issue377_predicament_progress_delta={} issue377_predicament_repeat_count={} issue377_predicament_evidence_gap_count={} issue377_predicament_action_novelty={} issue377_predicament_stuck={} issue377_self_trigger_stage={} issue377_evolution_apply_allowed={} issue377_experiment_plan_present=true issue377_experiment_plan_id={} issue377_experiment_plan_mode={} issue377_experiment_plan_level_path={} issue377_validation_skipped_levels={} issue377_validation_skipped_reason={} issue377_human_apply_level={} issue377_human_apply_inside_engine={} issue377_validation_level_apply_allowed={} issue377_experiment_plan_required_gates={} issue377_experiment_plan_budget_tokens={} issue377_experiment_plan_stop_on_fail={} issue377_experiment_plan_rollback_anchor={} issue377_experiment_plan_raw_payload_present={} issue377_experiment_plan_write_allowed={} issue377_experiment_plan_applied={} issue377_evidence_bundle_present=true issue377_evidence_bundle_id={} issue377_evidence_bundle_schema={} issue377_evidence_bundle_metric={} issue377_evidence_bundle_direction={} issue377_evidence_bundle_pass_count={} issue377_evidence_bundle_fail_count={} issue377_evidence_bundle_command_label={} issue377_evidence_bundle_refs_digest_only={} issue377_evidence_bundle_raw_payload_present={} issue377_evidence_bundle_write_allowed={} issue377_evidence_bundle_applied={} issue377_experiment_decision={} issue377_experiment_decision_schema={} issue377_experiment_decision_reason={} issue377_experiment_decision_evidence_bundle_id={} issue377_experiment_decision_target={} issue377_experiment_decision_manual_approval_required={} issue377_experiment_decision_apply_allowed={} issue377_experiment_runner_allowed={} issue377_experiment_apply_allowed={} issue377_mutation_candidate_emitter_present=true issue377_mutation_candidate_emitter_id={} issue377_mutation_candidate_id={} issue377_mutation_candidate_evidence_digest={} issue377_mutation_candidate_rollback_anchor={} issue377_mutation_candidate_requested_write_scope={} issue377_mutation_candidate_kind={} issue377_mutation_candidate_preview_only={} issue377_mutation_candidate_refs_digest_only={} issue377_mutation_candidate_writer_gate_preflight={} issue377_mutation_candidate_write_allowed={} issue377_mutation_candidate_applied={} issue377_mutation_candidate_apply_allowed={} issue377_mutation_candidate_manual_review_required={} issue377_candidate_emitter_lane_coverage={} issue377_candidate_emitter_kind_coverage={} issue377_candidate_emitter_coverage_count={} issue377_candidate_emitter_all_preview_only={} issue377_candidate_emitter_all_write_allowed={} issue377_candidate_emitter_all_apply_allowed={} issue377_candidate_emitter_all_manual_review_required={} issue377_candidate_emitter_durable_preflight_owner={} issue377_candidate_emitter_writer_gate_bypass_allowed={} issue377_candidate_emitter_direct_durable_write_allowed={} issue377_candidate_emitter_ready_for_explicit_apply={} issue377_related_issue_refs={} issue377_related_issue_scope_map={} issue377_related_issue_owner_scope={} issue377_related_issue_non_duplicate_count={} issue377_related_issue_all_non_duplicate={} issue377_related_issue_apply_allowed={} issue377_clean_room_reference_mode={} issue377_external_code_copied={} issue377_external_prompt_or_schema_copied={} issue377_restricted_license_material_copied={} issue377_license_provenance_posture={} issue377_clean_room_apply_allowed={} issue377_manual_approval_binding_present={} issue377_manual_approval_candidate_id={} issue377_manual_approval_evidence_digest={} issue377_manual_approval_rollback_anchor={} issue377_manual_approval_requested_write_scope={} issue377_manual_approval_ref={} issue377_manual_approval_expiration={} issue377_manual_approval_apply_allowed={} issue377_manual_approval_applied={}",
            ...
            self.self_observation_id,
            self.self_observation_schema,
            self.self_observation_signal_source,
            self.self_observation_source_digest,
            self.self_observation_window,
            self.self_observation_current_truth_digest,
            self.self_observation_digest_only,
            self.self_observation_raw_payload_present,
            self.self_observation_write_allowed,
            self.self_observation_applied,
            self.self_model_present,
            self.self_model_id,
            self.self_model_schema,
            self.self_model_scope,
            self.self_model_claims_consciousness,
            self.self_model_digest_only,
            self.self_model_raw_payload_present,
            self.self_model_write_allowed,
            self.self_model_applied,
            self.hypothesis_candidate_id,
            self.hypothesis_candidate_kind,
            self.hypothesis_candidate_status,
            self.hypothesis_candidate_target_surface,
            self.hypothesis_candidate_expected_metric,
            self.hypothesis_candidate_expected_direction,
            self.hypothesis_candidate_required_gates,
            self.hypothesis_candidate_rollback_anchor,
            self.hypothesis_candidate_raw_payload_present,
            self.hypothesis_candidate_write_allowed,
            self.hypothesis_candidate_applied,
            self.hypothesis_candidate_operator_approval_required,
            ...
            self.risk_override_action,
            self.negative_evidence_count,
            self.privacy_risk,
            self.license_risk,
            self.unsupported_capability_requested,
            self.unsafe_side_effect_allowed,
            self.risk_override_clear,
            ...
            self.experiment_plan_level_path,
            self.validation_skipped_levels,
            self.validation_skipped_reason,
            self.human_apply_level,
            self.human_apply_inside_engine,
            self.validation_level_apply_allowed,
            self.experiment_plan_required_gates,
            self.experiment_plan_budget_tokens,
            self.experiment_plan_stop_on_fail,
            self.experiment_plan_rollback_anchor,
            self.experiment_plan_raw_payload_present,
            self.experiment_plan_write_allowed,
            self.experiment_plan_applied,
            self.evidence_bundle_id,
            self.evidence_bundle_schema,
            self.evidence_bundle_metric,
            self.evidence_bundle_direction,
            self.evidence_bundle_pass_count,
            self.evidence_bundle_fail_count,
            self.evidence_bundle_command_label,
            self.evidence_bundle_refs_digest_only,
            self.evidence_bundle_raw_payload_present,
            self.evidence_bundle_write_allowed,
            self.evidence_bundle_applied,
            self.experiment_decision,
            self.experiment_decision_schema,
            self.experiment_decision_reason,
            self.experiment_decision_evidence_bundle_id,
            self.experiment_decision_target,
            self.experiment_decision_manual_approval_required,
            self.experiment_decision_apply_allowed,
            ...
            self.candidate_emitter_lane_coverage,
            self.candidate_emitter_kind_coverage,
            self.candidate_emitter_coverage_count,
            self.candidate_emitter_all_preview_only,
            self.candidate_emitter_all_write_allowed,
            self.candidate_emitter_all_apply_allowed,
            self.candidate_emitter_all_manual_review_required,
            self.candidate_emitter_durable_preflight_owner,
            self.candidate_emitter_writer_gate_bypass_allowed,
            self.candidate_emitter_direct_durable_write_allowed,
            self.candidate_emitter_ready_for_explicit_apply,
            self.related_issue_refs,
            self.related_issue_scope_map,
            self.related_issue_owner_scope,
            self.related_issue_non_duplicate_count,
            self.related_issue_all_non_duplicate,
            self.related_issue_apply_allowed,
            self.clean_room_reference_mode,
            self.external_code_copied,
            self.external_prompt_or_schema_copied,
            self.restricted_license_material_copied,
            self.license_provenance_posture,
            self.clean_room_apply_allowed,
...
enum Issue385PheromoneSignalSurface {
    DigestMarker,
}

impl Issue385PheromoneSignalSurface {
...
#[derive(Debug, Clone, PartialEq, Eq)]
struct Issue385SelfOntologyBodyMarker {
    body_state_id: String,
    pheromone_signal_marker_id: String,
    signal_surface: Issue385PheromoneSignalSurface,
    digest_gate_allowed: bool,
    read_only: bool,
    write_allowed: bool,
    applied: bool,
}

impl Issue385SelfOntologyBodyMarker {
    fn from_development_signal(
        finding: &DevelopmentPollutionFinding,
        gate: &DevelopmentEvidenceSurfaceGate,
    ) -> Self {
        ...
        let pheromone_signal_marker_id = stable_redaction_digest([
            "issue-385",
        ...
        Self {
            body_state_id,
            pheromone_signal_marker_id,
            signal_surface: Issue385PheromoneSignalSurface::DigestMarker,
            digest_gate_allowed: gate.surface == DevelopmentEvidenceUseSurface::DigestMarker
                && gate.source_digest == finding.source_digest
                && gate.allowed,
            read_only: true,
            write_allowed: false,
            applied: false,
    ...
    fn issue30_evidence_fields(&self) -> String {
        format!(
            "issue385_self_ontology_body_present=true issue385_body_state_id={} issue385_pheromone_signal_marker_present=true issue385_pheromone_signal_marker_id={} issue385_pheromone_signal_surface={} issue385_pheromone_signal_digest_gate_allowed={} issue385_pheromone_signal_preview_only={}",
            self.body_state_id,
            self.pheromone_signal_marker_id,
            self.signal_surface.as_str(),
            self.digest_gate_allowed,
            self.preview_only()
        )
    }
}
...
impl Issue493ToolOrganRegistry {
    fn from_reasoning_frame(reasoning_frame: &ReasoningFrame) -> Self {
...
pub fn issue30_entry_chain_evidence_line() -> String {
    ...
    let reasoning_frame = ReasoningFrame::issue375_preview(&body_marker.body_state_id);
    ...
    format!(
        ...
        reasoning_frame.issue375_evidence_fields(),
...
impl PersistentRoundtripReport {
    pub fn evaluate(input: PersistentRoundtripInput) -> Self {
        ...
        if input.second_planning_dense_compute_avoided_tokens == 0 {
            failures
                .push("second run did not report planning dense compute avoided tokens".to_owned());
        }
        ...
        Self {
            ...
            second_planning_dense_compute_avoided_tokens: input
    ...
    pub fn summary_line(&self) -> String {
        format!(
            ...
            self.second_planning_dense_compute_avoided_tokens,
...
impl PersistentRoundtripMatrixReport {
    ...
    pub fn second_planning_dense_compute_avoided_tokens(&self) -> usize {
        self.device_reports
            .iter()
            .map(|device_report| {
                device_report
    ...
    pub fn summary_line(&self) -> String {
        format!(
            "persistent_roundtrip_matrix: passed={} devices={} expected_devices={} failed_devices={} second_compute_budget_saved_tokens={} second_compute_budget_avoided_tokens={} second_planning_dense_compute_avoided_tokens={} second_compute_budget_kv_lookups_skipped={} failures={}",
            self.passed,
