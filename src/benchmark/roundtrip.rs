...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
enum Issue375ExpressionVmSideEffect {
    ReadOnly,
}

impl Issue375ExpressionVmSideEffect {
    fn as_str(self) -> &'static str {
        match self {
...
#[derive(Debug, Clone, PartialEq, Eq)]
struct Issue375ReasoningFrame {
    frame_id: String,
    environment_signals_present: bool,
    allowed_observations: &'static str,
    action_vocab: &'static str,
    suppressed_capabilities: &'static str,
    risk_limits: &'static str,
    expression_vm_side_effect: Issue375ExpressionVmSideEffect,
    genome_isa_apply_allowed: bool,
}

impl Issue375ReasoningFrame {
    fn from_body_marker(body_marker: &Issue385SelfOntologyBodyMarker) -> Self {
        Self {
            frame_id: stable_redaction_digest([
                ...
                "ReasoningFrame",
                body_marker.body_state_id.as_str(),
            ]),
            ...
            expression_vm_side_effect: Issue375ExpressionVmSideEffect::ReadOnly,
            genome_isa_apply_allowed: false,
        }
    }
    ...
    fn issue30_evidence_fields(&self) -> String {
        format!(
            ...
            self.risk_limits,
            self.expression_vm_side_effect.as_str(),
            self.genome_isa_apply_allowed,
        )
    }
}
