...
impl BenchmarkSummary {
    pub fn summary_line(&self) -> String {
        format!(
            ...
            self.genome_rejuvenation_cases(),
            self.genome_rejuvenation_decisions(),
            self.genome_rejuvenation_repair_factors(),
            self.genome_rejuvenation_ready_repair_factors(),
            self.genome_rejuvenation_ready_retag_plans(),
            self.genome_rejuvenation_rollback_ready(),
            self.genome_rejuvenation_replay_digests(),
            self.genome_rejuvenation_wasted_compute_reduction(),
            self.genome_rejuvenation_repair_factor_gate_reports(),
            self.genome_rejuvenation_repair_factor_gate_holds(),
            self.genome_rejuvenation_repair_factor_gate_ready(),
            self.genome_rejuvenation_repair_factor_gate_rejected(),
            self.genome_rejuvenation_repair_factor_gate_explicit_apply_required(),
            self.genome_rejuvenation_repair_factor_gate_durable_write_allowed(),
