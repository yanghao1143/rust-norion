...
impl BenchmarkSummary {
    pub fn summary_line(&self) -> String {
        let base = format!(
            ...
            self.dna_evolution_candidate_ledger_records(),
            self.dna_evolution_candidate_ledger_preview_only(),
            ...
            self.total_memory_admission_semantic_sources(),
            self.total_memory_admission_gist_sources(),
            self.total_memory_admission_runtime_kv_sources(),
            self.total_memory_admission_cold_sources(),
            self.total_memory_admission_gene_segment_sources(),
        ...
        format!(
            "{base} selected_chunks={} skipped_chunks={} kv_reuse={} genome_decisions={} quality_proxy={:.3} development_evidence_surface_blocks={} runtime_adapter_cache_mode_cases={} runtime_adapter_cache_modes={} runtime_adapter_cache_mode_values={} runtime_adapter_stream_trace_cases={} runtime_adapter_stream_gate_summary_cases={} runtime_adapter_stream_write_gate_cases={} runtime_adapter_stream_complete_cases={}",
            self.total_adaptive_routing_included()
            ...
            self.average_quality(),
            self.development_evidence_surface_blocks(),
