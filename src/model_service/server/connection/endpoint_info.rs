...
const HEALTH_DIAGNOSTICS_RESPONSE_FIELDS: &[&str] = &[
    ...
    "newapi_fallback.behavior_repair_attempt_timeout_secs",
    "newapi_fallback.behavior_repair_pool_budget_secs",
    "newapi_fallback.last_candidate_pool_mode",
    "newapi_fallback.last_candidate_pool_budget_secs",
    "newapi_fallback.last_candidate_pool_elapsed_ms",
    "newapi_fallback.last_candidate_pool_budget_exhausted",
    "newapi_fallback.last_behavior_repair_budget_exhausted",
...
fn endpoint_response_fields(endpoint: &str) -> &'static [&'static str] {
    match endpoint {
        ...
        "evolution" => &[
            ...
            "rollback_token",
            "error",
            "norion.evolution_benefit_gate",
            "norion.evolution_benefit_gate.executed",
            "norion.evolution_benefit_gate.passed",
            "norion.evolution_benefit_gate.decision",
            "norion.evolution_benefit_gate.reason",
            "norion.evolution_benefit_gate.shadow_only",
            "norion.evolution_benefit_gate.probe_runtime_error",
            "norion.evolution_benefit_gate.baseline",
            "norion.evolution_benefit_gate.baseline.quality_milli",
            "norion.evolution_benefit_gate.baseline.process_reward_milli",
            "norion.evolution_benefit_gate.baseline.elapsed_ms",
            "norion.evolution_benefit_gate.baseline.token_count",
            "norion.evolution_benefit_gate.probe",
            "norion.evolution_benefit_gate.probe.quality_milli",
            "norion.evolution_benefit_gate.probe.process_reward_milli",
            "norion.evolution_benefit_gate.probe.elapsed_ms",
            "norion.evolution_benefit_gate.probe.token_count",
            "norion.dna_closed_loop",
            "norion.dna_closed_loop.generation_before",
            "norion.dna_closed_loop.generation_after",
            "norion.dna_closed_loop.mutation_count",
...
mod tests {
    ...
    fn endpoint_info_json_reports_openai_chat_completions_contract() {
        ...
        assert!(json.contains("\"norion.used_memory_count\",\"norion.used_memory_ids\",\"norion.reflection_issue_codes\",\"norion.revision_actions\",\"norion.stored_runtime_kv_memory_ids\",\"norion.route_threshold\",\"norion.route_attention_tokens\",\"norion.route_fast_tokens\",\"norion.route_attention_fraction\""));
