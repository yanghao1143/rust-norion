...
pub use reasoning_genome::{
    ...
    MutationRepairFixtureResult, ReasoningGene, ReasoningGeneKind, ReasoningGeneStatus,
    ReasoningGenome, SubAgentExpressionTrace, TASK_EXPRESSION_GENE_SCHEMA_VERSION,
