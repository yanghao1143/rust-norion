...
pub use reasoning_genome::{
    ...
    ReasoningGeneKind, ReasoningGeneStatus, ReasoningGenome, SubAgentExpressionTrace,
    TASK_EXPRESSION_GENE_SCHEMA_VERSION, TASK_SKILL_GENE_SCHEMA_VERSION, TaskExpressionGene,
    TaskGeneAdmissionDecision, TaskGeneAdmissionReview, TaskGeneCascade, TaskGeneCascadeMode,
    TaskGeneGermLayer, TaskGeneSurfaceLink, TaskGeneTraceCounters, TaskSkillGeneCandidate,
    TaskSkillGeneDecision, TaskSkillGeneEvidence, TaskSkillGeneInput, TaskSkillGeneScorer,
    TaskSkillGeneScoringPolicy, default_issue379_primitive_decision,
