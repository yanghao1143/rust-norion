...
pub struct TraceSchemaGateReport {
    ...
    pub external_agent_lifecycle_project_scoped: usize,
    pub external_agent_lifecycle_project_scope_mismatch: usize,
    pub external_agent_lifecycle_foreign_project: usize,
...
impl TraceSchemaGateReport {
    ...
    fn issue185_external_agent_lifecycle_ready(&self) -> bool {
        self.external_agent_lifecycle_events > 0
            ...
            && self.external_agent_lifecycle_project_scoped == self.external_agent_lifecycle_agents
            && self.external_agent_lifecycle_project_scope_mismatch == 0
            && self.external_agent_lifecycle_foreign_project == 0
    ...
    pub fn summary_line(&self) -> String {
        let base = format!(
            ...
            self.external_agent_lifecycle_project_scoped,
            self.external_agent_lifecycle_project_scope_mismatch,
            self.external_agent_lifecycle_foreign_project,
...
pub fn evaluate_trace_schema_jsonl(path: impl AsRef<Path>) -> io::Result<TraceSchemaGateReport> {
    ...
    let mut external_agent_lifecycle_project_scoped = 0;
    let mut external_agent_lifecycle_project_scope_mismatch = 0;
    let mut external_agent_lifecycle_foreign_project = 0;
    ...
    for (index, line) in content.lines().enumerate() {
        ...
        if let Some(summary) = external_agent_lifecycle_trace_gate_summary(line) {
            ...
            external_agent_lifecycle_project_scoped += summary.project_scoped;
            external_agent_lifecycle_project_scope_mismatch += summary.project_scope_mismatch;
            external_agent_lifecycle_foreign_project += summary.foreign_project;
    ...
    Ok(TraceSchemaGateReport {
        ...
        external_agent_lifecycle_project_scoped,
...
struct ExternalAgentLifecycleTraceGateSummary {
    ...
    project_scoped: usize,
    project_scope_mismatch: usize,
    foreign_project: usize,
...
fn external_agent_lifecycle_trace_gate_summary(
    ...
    Some(ExternalAgentLifecycleTraceGateSummary {
        ...
        project_scoped: extract_json_usize_field(line, "project_scoped").unwrap_or(0),
        project_scope_mismatch: extract_json_usize_field(line, "project_scope_mismatch")
            .unwrap_or(0),
        foreign_project: extract_json_usize_field(line, "foreign_project").unwrap_or(0),
