...
pub fn trace_json_line_with_case(
    ...
    let reasoning_frame_opcodes = outcome
        .reasoning_frame
        .executed_opcodes
        .iter()
        .map(|opcode| opcode.as_str().to_owned())
        .collect::<Vec<_>>();
    ...
    format!(
        "{{\
         ...
         \"recursive\":{{\"required\":{},\"prompt_tokens\":{},\"native_window\":{},\"chunks\":{},\"merge_rounds\":{},\"execution_waves\":{},\"max_parallel_chunks\":{},\"dispatched_waves\":{},\"parallel_waves\":{},\"max_dispatch_width\":{},\"chunk_tokens\":{},\"overlap_tokens\":{},\"runtime_calls\":{}}},\
         ...
         \"memory_admission\":{{\"candidates\":{},\"ready\":{},\"blocked\":{},\"admitted\":{},\"hold\":{},\"reject\":{},\"quarantine\":{},\"kinds\":{},\"source_semantic\":{},\"source_gist\":{},\"source_runtime_kv\":{},\"source_cold\":{},\"source_gene_segment\":{},\"decisions\":{},\"candidate_summaries\":{},\"review_packets\":{},\"review_packet_summaries\":{},\"trace_segment_priors\":{},\"trace_segment_prior_summaries\":{},\"ledger_records\":{},\"ledger_authorized\":{},\"ledger_applied\":{},\"ledger_preview_only\":{},\"ledger_held\":{},\"ledger_rejected\":{},\"ledger_duplicate\":{},\"ledger_decayed\":{},\"ledger_merged\":{},\"ledger_rollback\":{},\"ledger_summaries\":{},\"read_only\":{},\"write_allowed\":{},\"applied\":{}}},\
        ...
        outcome.recursive_schedule.dispatched_wave_count,
        outcome.recursive_schedule.parallel_wave_count,
        outcome.recursive_schedule.max_dispatch_width,
        ...
        outcome.genome_strategy.as_str(),
        json_escape(&outcome.strategy_genome.genome_id),
        ...
        string_array_json(&reasoning_frame_opcodes),
        json_escape(&outcome.reasoning_frame.routing_bias_evidence_value()),
        json_escape(&outcome.reasoning_frame.memory_policy_evidence_value()),
        outcome.reasoning_frame.mutation_preview.len(),
        ...
        outcome.dna_apply_receipt.dual_chain_committed,
        outcome.dna_apply_receipt.express_chain_records,
        outcome.dna_apply_receipt.memory_chain_records,
        ...
        outcome.memory_admission.semantic_source_count(),
        outcome.memory_admission.gist_source_count(),
        outcome.memory_admission.runtime_kv_source_count(),
        outcome.memory_admission.cold_source_count(),
        outcome.memory_admission.gene_segment_source_count(),
