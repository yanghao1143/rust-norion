...
pub(super) const CORE_TRACE_REQUIRED_FIELDS: &[TraceRequiredField] = &[
    ...
    required_field("recursive_dispatched_waves", "\"dispatched_waves\":"),
    required_field("recursive_parallel_waves", "\"parallel_waves\":"),
    required_field("recursive_max_dispatch_width", "\"max_dispatch_width\":"),
