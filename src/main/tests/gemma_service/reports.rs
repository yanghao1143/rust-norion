...
fn model_service_state_json_includes_gate_evidence() {
    ...
    assert!(body.contains("\"hierarchy_convolution\":0.200000"));
    assert!(body.contains("\"profile_hierarchy_global_general\":0.300000"));
    assert!(body.contains("\"profile_hierarchy_local_general\":0.500000"));
    assert!(body.contains("\"profile_hierarchy_convolution_general\":0.200000"));
    assert!(body.contains("\"profile_hierarchy_global_coding\":0.160000"));
    assert!(body.contains("\"profile_hierarchy_local_coding\":0.680000"));
    assert!(body.contains("\"profile_hierarchy_convolution_coding\":0.160000"));
    assert!(body.contains("\"profile_hierarchy_global_writing\":0.550000"));
    assert!(body.contains("\"profile_hierarchy_local_writing\":0.250000"));
    assert!(body.contains("\"profile_hierarchy_convolution_writing\":0.200000"));
    assert!(body.contains("\"profile_hierarchy_global_long_document\":0.720000"));
    assert!(body.contains("\"profile_hierarchy_local_long_document\":0.180000"));
    assert!(body.contains("\"profile_hierarchy_convolution_long_document\":0.100000"));
