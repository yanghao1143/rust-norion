...
pub struct RuntimeDiagnostics {
    ...
    pub model_fallback_primary_failed: bool,
    pub model_fallback_used: bool,
    pub model_fallback_attempts: usize,
    pub model_fallback_failures: usize,
    pub model_fallback_quarantined: usize,
    pub model_fallback_cooldown_skipped: usize,
    pub model_fallback_selected_model: Option<String>,
    pub model_fallback_all_failed: bool,
