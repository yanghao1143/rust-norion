...
impl StateInspectionMatrixGateReport {
    ...
    pub fn runtime_kv_weak_import_pressure_device_profiles(&self) -> usize {
        runtime_kv_weak_import_pressure_device_profiles(&self.device_reports)
    }

    pub fn runtime_kv_budget_import_skip_device_profiles(&self) -> usize {
        runtime_kv_budget_import_skip_device_profiles(&self.device_reports)
    }

    pub fn runtime_kv_budget_pressure_device_profiles(&self) -> usize {
        runtime_kv_budget_pressure_device_profiles(&self.device_reports)
    }
    ...
    pub fn summary_line(&self) -> String {
        format!(
            ...
            self.runtime_kv_weak_import_pressure_device_profiles(),
            self.runtime_kv_budget_import_skip_device_profiles(),
            self.runtime_kv_budget_pressure_device_profiles(),
