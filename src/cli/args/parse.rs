    ...
    pub(crate) fn parse(raw: Vec<String>) -> Self {
        ...
        while index < raw.len() {
            ...
            if let Some(consumed) = (BenchmarkFlagParse {
                ...
                benchmark_min_live_memory_feedback_reinforcements: &mut state.benchmark_min_live_memory_feedback_reinforcements,
                benchmark_min_live_memory_feedback_penalties: &mut state.benchmark_min_live_memory_feedback_penalties,
                benchmark_min_live_memory_feedback_applied: &mut state.benchmark_min_live_memory_feedback_applied,
                benchmark_min_live_memory_feedback_strength_delta: &mut state.benchmark_min_live_memory_feedback_strength_delta,
                benchmark_max_live_memory_feedback_missing: &mut state.benchmark_max_live_memory_feedback_missing,
                benchmark_min_auto_replay_live_memory_feedback_updates: &mut state.benchmark_min_auto_replay_live_memory_feedback_updates,
                benchmark_min_auto_replay_live_memory_feedback_reinforcements: &mut state.benchmark_min_auto_replay_live_memory_feedback_reinforcements,
                benchmark_min_auto_replay_live_memory_feedback_penalties: &mut state.benchmark_min_auto_replay_live_memory_feedback_penalties,
                ...
                benchmark_max_auto_replay_live_memory_feedback_missing: &mut state.benchmark_max_auto_replay_live_memory_feedback_missing,
                ...
                benchmark_min_auto_replay_runtime_kv_budget_pressure_items: &mut state.benchmark_min_auto_replay_runtime_kv_budget_pressure_items,
                benchmark_min_auto_replay_runtime_kv_budget_pressure: &mut state.benchmark_min_auto_replay_runtime_kv_budget_pressure,
                benchmark_max_auto_replay_runtime_kv_budget_pressure: &mut state.benchmark_max_auto_replay_runtime_kv_budget_pressure,
                benchmark_min_auto_replay_runtime_kv_weak_import_pressure_items: &mut state.benchmark_min_auto_replay_runtime_kv_weak_import_pressure_items,
                benchmark_min_auto_replay_runtime_kv_weak_import_pressure: &mut state.benchmark_min_auto_replay_runtime_kv_weak_import_pressure,
                benchmark_max_auto_replay_runtime_kv_weak_import_pressure: &mut state.benchmark_max_auto_replay_runtime_kv_weak_import_pressure,
                ...
                benchmark_min_evolution_live_memory_reinforcements: &mut state.benchmark_min_evolution_live_memory_reinforcements,
                benchmark_min_evolution_live_memory_penalties: &mut state.benchmark_min_evolution_live_memory_penalties,
                benchmark_min_evolution_live_stored_memories: &mut state.benchmark_min_evolution_live_stored_memories,
                benchmark_min_evolution_live_stored_gist_memories: &mut state.benchmark_min_evolution_live_stored_gist_memories,
                benchmark_min_evolution_live_stored_runtime_kv_memories: &mut state.benchmark_min_evolution_live_stored_runtime_kv_memories,
                ...
                benchmark_min_evolution_external_feedbacks: &mut state.benchmark_min_evolution_external_feedbacks,
                benchmark_min_evolution_external_feedback_reinforcements: &mut state.benchmark_min_evolution_external_feedback_reinforcements,
                benchmark_min_evolution_external_feedback_penalties: &mut state.benchmark_min_evolution_external_feedback_penalties,
                benchmark_min_evolution_external_feedback_memory_updates: &mut state.benchmark_min_evolution_external_feedback_memory_updates,
                benchmark_min_evolution_external_feedback_strength_delta: &mut state.benchmark_min_evolution_external_feedback_strength_delta,
                benchmark_max_evolution_external_feedback_missing: &mut state.benchmark_max_evolution_external_feedback_missing,
                ...
                benchmark_min_evolution_replay_live_memory_feedback_reinforcements: &mut state.benchmark_min_evolution_replay_live_memory_feedback_reinforcements,
                benchmark_min_evolution_replay_live_memory_feedback_penalties: &mut state.benchmark_min_evolution_replay_live_memory_feedback_penalties,
                ...
                benchmark_max_evolution_replay_live_memory_feedback_missing: &mut state.benchmark_max_evolution_replay_live_memory_feedback_missing,
                ...
                benchmark_min_improvement_corpus_reports: &mut state.benchmark_min_improvement_corpus_reports,
                benchmark_min_improvement_corpus_episodes: &mut state.benchmark_min_improvement_corpus_episodes,
                benchmark_min_improvement_corpus_active_adaptation: &mut state.benchmark_min_improvement_corpus_active_adaptation,
                benchmark_min_improvement_corpus_compiler_passed: &mut state.benchmark_min_improvement_corpus_compiler_passed,
                benchmark_min_improvement_corpus_test_passed: &mut state.benchmark_min_improvement_corpus_test_passed,
                benchmark_min_improvement_corpus_benchmark_passed: &mut state.benchmark_min_improvement_corpus_benchmark_passed,
                benchmark_min_improvement_corpus_rollback_replayed: &mut state.benchmark_min_improvement_corpus_rollback_replayed,
                benchmark_max_improvement_corpus_secret_leaks: &mut state.benchmark_max_improvement_corpus_secret_leaks,
                benchmark_max_improvement_corpus_dataset_export_enabled: &mut state.benchmark_max_improvement_corpus_dataset_export_enabled,
        ...
        benchmark_min_runtime_kv_weak_import_skip_device_profiles: &mut state.benchmark_min_runtime_kv_weak_import_skip_device_profiles,
        ...
        benchmark_min_runtime_kv_segment_cases: &mut state.benchmark_min_runtime_kv_segment_cases,
                ...
                benchmark_max_runtime_kv_segments_skipped: &mut state.benchmark_max_runtime_kv_segments_skipped,
                benchmark_max_runtime_kv_segments_rejected: &mut state.benchmark_max_runtime_kv_segments_rejected,
                benchmark_min_runtime_kv_segment_device_profiles: &mut state.benchmark_min_runtime_kv_segment_device_profiles,
                ...
                benchmark_min_runtime_adapter_stream_complete_cases: &mut state.benchmark_min_runtime_adapter_stream_complete_cases,
                ...
                benchmark_max_memory_feedback_evidence_failures: &mut state.benchmark_max_memory_feedback_evidence_failures,
                benchmark_max_adaptive_routing_failures: &mut state.benchmark_max_adaptive_routing_failures,
                benchmark_min_adaptive_routing_cases: &mut state.benchmark_min_adaptive_routing_cases,
                benchmark_min_adaptive_routing_device_profiles: &mut state.benchmark_min_adaptive_routing_device_profiles,
                benchmark_min_adaptive_routing_saved_tokens: &mut state.benchmark_min_adaptive_routing_saved_tokens,
                benchmark_min_adaptive_routing_saved_token_device_profiles: &mut state.benchmark_min_adaptive_routing_saved_token_device_profiles,
                benchmark_min_task_hierarchy_cases: &mut state.benchmark_min_task_hierarchy_cases,
                benchmark_min_task_hierarchy_modes: &mut state.benchmark_min_task_hierarchy_modes,
                benchmark_min_task_hierarchy_mutation_records: &mut state.benchmark_min_task_hierarchy_mutation_records,
                benchmark_min_task_hierarchy_compute_reduction_milli: &mut state.benchmark_min_task_hierarchy_compute_reduction_milli,
                benchmark_min_compute_budget_saved_tokens: &mut state.benchmark_min_compute_budget_saved_tokens,
                benchmark_min_compute_budget_self_evolving_memory_fusion_saved_tokens: &mut state.benchmark_min_compute_budget_self_evolving_memory_fusion_saved_tokens,
                benchmark_min_compute_budget_avoided_tokens: &mut state.benchmark_min_compute_budget_avoided_tokens,
                benchmark_min_compute_budget_fanout_reduction: &mut state.benchmark_min_compute_budget_fanout_reduction,
                benchmark_min_kv_fusion_cases: &mut state.benchmark_min_kv_fusion_cases,
                benchmark_min_kv_fusion_candidates: &mut state.benchmark_min_kv_fusion_candidates,
                benchmark_min_kv_fusion_saved_tokens: &mut state.benchmark_min_kv_fusion_saved_tokens,
                benchmark_max_kv_fusion_skipped: &mut state.benchmark_max_kv_fusion_skipped,
                benchmark_max_kv_fusion_held: &mut state.benchmark_max_kv_fusion_held,
                benchmark_max_kv_fusion_rejected: &mut state.benchmark_max_kv_fusion_rejected,
                benchmark_max_kv_fusion_approval_blocked: &mut state
                    .benchmark_max_kv_fusion_approval_blocked,
                benchmark_max_reasoning_genome_failures: &mut state.benchmark_max_reasoning_genome_failures,
                ...
                benchmark_min_memory_storage_benchmark_samples: &mut state.benchmark_min_memory_storage_benchmark_samples,
                benchmark_min_memory_storage_removed_entries: &mut state.benchmark_min_memory_storage_removed_entries,
                benchmark_min_memory_retrieval_latency_samples: &mut state.benchmark_min_memory_retrieval_latency_samples,
                benchmark_max_memory_retrieval_latency_avg_ms: &mut state.benchmark_max_memory_retrieval_latency_avg_ms,
                benchmark_min_memory_retained_usefulness_abs_delta_milli: &mut state.benchmark_min_memory_retained_usefulness_abs_delta_milli,
            ...
            if let Some(consumed) = (InspectFlagParse {
                ...
                inspect_max_runtime_error_message_chars: &mut state.inspect_max_runtime_error_message_chars,
                ...
                inspect_min_runtime_imported_kv_blocks: &mut state.inspect_min_runtime_imported_kv_blocks,
                inspect_min_self_evolving_memory_writeback_experiences: &mut state.inspect_min_self_evolving_memory_writeback_experiences,
                inspect_min_self_evolving_memory_writeback_attempted_records: &mut state.inspect_min_self_evolving_memory_writeback_attempted_records,
                inspect_min_self_evolving_memory_writeback_accepted_records: &mut state.inspect_min_self_evolving_memory_writeback_accepted_records,
                inspect_max_self_evolving_memory_writeback_rejected_records: &mut state.inspect_max_self_evolving_memory_writeback_rejected_records,
                inspect_min_self_evolving_memory_writeback_write_allowed: &mut state.inspect_min_self_evolving_memory_writeback_write_allowed,
                inspect_min_self_evolving_memory_writeback_durable_write_allowed: &mut state.inspect_min_self_evolving_memory_writeback_durable_write_allowed,
                inspect_min_self_evolving_memory_writeback_applied: &mut state.inspect_min_self_evolving_memory_writeback_applied,
                inspect_min_self_evolving_memory_writeback_applied_to_disk: &mut state.inspect_min_self_evolving_memory_writeback_applied_to_disk,
                inspect_min_self_evolving_memory_writeback_snapshot_changes: &mut state.inspect_min_self_evolving_memory_writeback_snapshot_changes,
        inspect_min_runtime_kv_weak_import_skip_experiences: &mut state.inspect_min_runtime_kv_weak_import_skip_experiences,
        inspect_min_weak_runtime_kv_imports_skipped: &mut state.inspect_min_weak_runtime_kv_imports_skipped,
        inspect_min_runtime_kv_weak_import_pressure_experiences: &mut state.inspect_min_runtime_kv_weak_import_pressure_experiences,
        inspect_min_runtime_kv_weak_import_pressure: &mut state.inspect_min_runtime_kv_weak_import_pressure,
        inspect_max_runtime_kv_weak_import_pressure: &mut state.inspect_max_runtime_kv_weak_import_pressure,
        inspect_min_runtime_kv_budget_import_skip_experiences: &mut state.inspect_min_runtime_kv_budget_import_skip_experiences,
        inspect_min_budget_limited_runtime_kv_imports_skipped: &mut state.inspect_min_budget_limited_runtime_kv_imports_skipped,
        inspect_min_runtime_kv_budget_pressure_experiences: &mut state.inspect_min_runtime_kv_budget_pressure_experiences,
        inspect_min_runtime_kv_budget_pressure: &mut state.inspect_min_runtime_kv_budget_pressure,
        inspect_max_runtime_kv_budget_pressure: &mut state.inspect_max_runtime_kv_budget_pressure,
                inspect_min_runtime_kv_export_experiences: &mut state.inspect_min_runtime_kv_export_experiences,
                inspect_min_runtime_kv_segment_experiences: &mut state.inspect_min_runtime_kv_segment_experiences,
                inspect_min_runtime_kv_segments_included: &mut state.inspect_min_runtime_kv_segments_included,
                inspect_max_runtime_kv_segments_skipped: &mut state.inspect_max_runtime_kv_segments_skipped,
                inspect_max_runtime_kv_segments_rejected: &mut state.inspect_max_runtime_kv_segments_rejected,
                ...
                inspect_min_fht_dke_budget_experiences: &mut state.inspect_min_fht_dke_budget_experiences,
                inspect_min_fht_dke_enabled_experiences: &mut state.inspect_min_fht_dke_enabled_experiences,
                inspect_min_fht_dke_routed_tokens: &mut state.inspect_min_fht_dke_routed_tokens,
                inspect_max_fht_dke_token_split_invalid: &mut state.inspect_max_fht_dke_token_split_invalid,
                inspect_min_fht_dke_attention_threshold: &mut state.inspect_min_fht_dke_attention_threshold,
                inspect_max_fht_dke_attention_threshold: &mut state.inspect_max_fht_dke_attention_threshold,
                inspect_min_fht_dke_route_pressure: &mut state.inspect_min_fht_dke_route_pressure,
                inspect_max_fht_dke_route_pressure: &mut state.inspect_max_fht_dke_route_pressure,
        ...
        inspect_min_runtime_kv_weak_import_pressure_device_profiles: &mut state.inspect_min_runtime_kv_weak_import_pressure_device_profiles,
        ...
        inspect_min_runtime_kv_export_device_profiles: &mut state.inspect_min_runtime_kv_export_device_profiles,
                ...
                inspect_min_process_reward_experiences: &mut state.inspect_min_process_reward_experiences,
                inspect_min_process_reward_positive: &mut state.inspect_min_process_reward_positive,
                inspect_min_process_reward_reinforce: &mut state.inspect_min_process_reward_reinforce,
                inspect_min_process_reward_total: &mut state.inspect_min_process_reward_total,
                inspect_max_pool_dispatch_clamped: &mut state.inspect_max_pool_dispatch_clamped,
                inspect_max_pool_dispatch_low_priority: &mut state.inspect_max_pool_dispatch_low_priority,
                inspect_min_external_semantic_context_experiences: &mut state.inspect_min_external_semantic_context_experiences,
                inspect_min_external_semantic_contexts: &mut state.inspect_min_external_semantic_contexts,
                ...
                inspect_min_live_memory_feedback_reinforced: &mut state.inspect_min_live_memory_feedback_reinforced,
                inspect_min_live_memory_feedback_penalized: &mut state.inspect_min_live_memory_feedback_penalized,
                ...
                inspect_max_live_memory_feedback_missing: &mut state.inspect_max_live_memory_feedback_missing,
                ...
                inspect_min_business_contract_experiences: &mut state.inspect_min_business_contract_experiences,
                inspect_min_business_contract_passed: &mut state.inspect_min_business_contract_passed,
                inspect_max_business_contract_failed: &mut state.inspect_max_business_contract_failed,
                inspect_max_business_contract_missing_signals: &mut state.inspect_max_business_contract_missing_signals,
                inspect_max_business_contract_protocol_leaks: &mut state.inspect_max_business_contract_protocol_leaks,
                inspect_max_business_contract_substitutions: &mut state.inspect_max_business_contract_substitutions,
                inspect_max_business_contract_evasive_denials: &mut state.inspect_max_business_contract_evasive_denials,
                inspect_max_business_contract_missing_handling_signals: &mut state.inspect_max_business_contract_missing_handling_signals,
                ...
                inspect_min_evolution_live_memory_reinforcements: &mut state.inspect_min_evolution_live_memory_reinforcements,
                inspect_min_evolution_live_memory_penalties: &mut state.inspect_min_evolution_live_memory_penalties,
                inspect_min_evolution_live_stored_memories: &mut state.inspect_min_evolution_live_stored_memories,
                inspect_min_evolution_live_stored_gist_memories: &mut state.inspect_min_evolution_live_stored_gist_memories,
                inspect_min_evolution_live_stored_runtime_kv_memories: &mut state.inspect_min_evolution_live_stored_runtime_kv_memories,
                ...
                inspect_min_evolution_external_feedback_reinforcements: &mut state.inspect_min_evolution_external_feedback_reinforcements,
                inspect_min_evolution_external_feedback_penalties: &mut state.inspect_min_evolution_external_feedback_penalties,
                ...
                inspect_max_evolution_external_feedback_missing: &mut state.inspect_max_evolution_external_feedback_missing,
                ...
                inspect_min_evolution_replay_live_memory_feedback_reinforcements: &mut state.inspect_min_evolution_replay_live_memory_feedback_reinforcements,
                inspect_min_evolution_replay_live_memory_feedback_penalties: &mut state.inspect_min_evolution_replay_live_memory_feedback_penalties,
                ...
                inspect_max_evolution_replay_live_memory_feedback_missing: &mut state.inspect_max_evolution_replay_live_memory_feedback_missing,
                ...
                inspect_min_evolution_replay_business_contract_items: &mut state.inspect_min_evolution_replay_business_contract_items,
                inspect_min_evolution_replay_business_contract_passed: &mut state.inspect_min_evolution_replay_business_contract_passed,
                inspect_max_evolution_replay_business_contract_failed: &mut state.inspect_max_evolution_replay_business_contract_failed,
                inspect_min_evolution_replay_business_contract_raw_audits: &mut state.inspect_min_evolution_replay_business_contract_raw_audits,
            ...
            match raw[index].as_str() {
                ...
                "--runtime-state-retire" => {
                    state.runtime_state_retire = true;
                    index += 1;
                }
                "--runtime-state-retire-apply" => {
                    state.runtime_state_retire = true;
                    state.runtime_state_retire_apply = true;
                    index += 1;
                }
                "--self-evolving-memory-quarantine-source-case" if index + 1 < raw.len() => {
                    state.self_evolving_memory_quarantine_source_case =
                        Some(raw[index + 1].to_owned());
                    index += 2;
                }
                "--self-evolving-memory-quarantine-reason" if index + 1 < raw.len() => {
                    state.self_evolving_memory_quarantine_reason = raw[index + 1].to_owned();
                    index += 2;
                }
                "--self-evolving-memory-quarantine-apply" => {
                    state.self_evolving_memory_quarantine_apply = true;
                    index += 1;
                }
