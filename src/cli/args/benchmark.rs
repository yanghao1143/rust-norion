...
pub(crate) struct BenchmarkFlagParse<'a> {
    ...
    pub(crate) benchmark_min_live_memory_feedback_reinforcements: &'a mut Option<usize>,
    pub(crate) benchmark_min_live_memory_feedback_penalties: &'a mut Option<usize>,
    pub(crate) benchmark_min_live_memory_feedback_applied: &'a mut Option<usize>,
    pub(crate) benchmark_min_live_memory_feedback_strength_delta: &'a mut Option<f32>,
    pub(crate) benchmark_max_live_memory_feedback_missing: &'a mut Option<usize>,
    pub(crate) benchmark_min_auto_replay_live_memory_feedback_updates: &'a mut Option<usize>,
    pub(crate) benchmark_min_auto_replay_live_memory_feedback_reinforcements: &'a mut Option<usize>,
    pub(crate) benchmark_min_auto_replay_live_memory_feedback_penalties: &'a mut Option<usize>,
    ...
    pub(crate) benchmark_max_auto_replay_live_memory_feedback_missing: &'a mut Option<usize>,
    ...
    pub(crate) benchmark_min_evolution_live_memory_reinforcements: &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_live_memory_penalties: &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_live_stored_memories: &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_live_stored_gist_memories: &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_live_stored_runtime_kv_memories: &'a mut Option<u64>,
    ...
    pub(crate) benchmark_min_evolution_external_feedbacks: &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_external_feedback_reinforcements: &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_external_feedback_penalties: &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_external_feedback_memory_updates: &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_external_feedback_strength_delta: &'a mut Option<f32>,
    pub(crate) benchmark_max_evolution_external_feedback_missing: &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_replay_live_memory_feedback_updates: &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_replay_live_memory_feedback_reinforcements:
        &'a mut Option<u64>,
    pub(crate) benchmark_min_evolution_replay_live_memory_feedback_penalties: &'a mut Option<u64>,
    ...
    pub(crate) benchmark_min_evolution_replay_live_memory_feedback_strength_delta:
        &'a mut Option<f32>,
    pub(crate) benchmark_max_evolution_replay_live_memory_feedback_missing: &'a mut Option<u64>,
    ...
    pub(crate) benchmark_min_evolution_replay_rust_check_live_memory_feedback_strength_delta:
        &'a mut Option<f32>,
    pub(crate) benchmark_min_improvement_corpus_reports: &'a mut Option<usize>,
    pub(crate) benchmark_min_improvement_corpus_episodes: &'a mut Option<usize>,
    pub(crate) benchmark_min_improvement_corpus_active_adaptation: &'a mut Option<usize>,
    pub(crate) benchmark_min_improvement_corpus_compiler_passed: &'a mut Option<u64>,
    pub(crate) benchmark_min_improvement_corpus_test_passed: &'a mut Option<u64>,
    pub(crate) benchmark_min_improvement_corpus_benchmark_passed: &'a mut Option<u64>,
    pub(crate) benchmark_min_improvement_corpus_rollback_replayed: &'a mut Option<usize>,
    pub(crate) benchmark_max_improvement_corpus_secret_leaks: &'a mut Option<usize>,
    pub(crate) benchmark_max_improvement_corpus_dataset_export_enabled: &'a mut Option<usize>,
    ...
    pub(crate) benchmark_min_runtime_kv_budget_pressure_cases: &'a mut Option<usize>,
    pub(crate) benchmark_min_runtime_kv_budget_pressure_device_profiles: &'a mut Option<usize>,
    ...
    pub(crate) benchmark_max_runtime_kv_segments_skipped: &'a mut Option<usize>,
    ...
    pub(crate) benchmark_min_runtime_adapter_stream_complete_cases: &'a mut Option<usize>,
    ...
    pub(crate) benchmark_max_memory_feedback_evidence_failures: &'a mut Option<usize>,
    pub(crate) benchmark_max_adaptive_routing_failures: &'a mut Option<usize>,
    pub(crate) benchmark_min_adaptive_routing_cases: &'a mut Option<usize>,
    pub(crate) benchmark_min_adaptive_routing_device_profiles: &'a mut Option<usize>,
    pub(crate) benchmark_min_adaptive_routing_saved_tokens: &'a mut Option<usize>,
    pub(crate) benchmark_min_adaptive_routing_saved_token_device_profiles: &'a mut Option<usize>,
    pub(crate) benchmark_min_task_hierarchy_cases: &'a mut Option<usize>,
    pub(crate) benchmark_min_task_hierarchy_modes: &'a mut Option<usize>,
    pub(crate) benchmark_min_task_hierarchy_mutation_records: &'a mut Option<usize>,
    pub(crate) benchmark_min_task_hierarchy_compute_reduction_milli: &'a mut Option<usize>,
    pub(crate) benchmark_min_compute_budget_saved_tokens: &'a mut Option<usize>,
    pub(crate) benchmark_min_compute_budget_self_evolving_memory_fusion_saved_tokens:
        &'a mut Option<usize>,
    pub(crate) benchmark_min_compute_budget_avoided_tokens: &'a mut Option<usize>,
    pub(crate) benchmark_min_compute_budget_fanout_reduction: &'a mut Option<usize>,
    pub(crate) benchmark_min_kv_fusion_cases: &'a mut Option<usize>,
    pub(crate) benchmark_min_kv_fusion_candidates: &'a mut Option<usize>,
    pub(crate) benchmark_min_kv_fusion_saved_tokens: &'a mut Option<usize>,
    pub(crate) benchmark_max_kv_fusion_skipped: &'a mut Option<usize>,
    pub(crate) benchmark_max_kv_fusion_held: &'a mut Option<usize>,
    pub(crate) benchmark_max_kv_fusion_rejected: &'a mut Option<usize>,
    pub(crate) benchmark_max_kv_fusion_approval_blocked: &'a mut Option<usize>,
    pub(crate) benchmark_max_reasoning_genome_failures: &'a mut Option<usize>,
    ...
    pub(crate) benchmark_min_memory_storage_benchmark_samples: &'a mut Option<usize>,
    pub(crate) benchmark_min_memory_storage_removed_entries: &'a mut Option<usize>,
    pub(crate) benchmark_min_memory_retrieval_latency_samples: &'a mut Option<usize>,
    pub(crate) benchmark_max_memory_retrieval_latency_avg_ms: &'a mut Option<u128>,
    pub(crate) benchmark_min_memory_retained_usefulness_abs_delta_milli: &'a mut Option<usize>,
