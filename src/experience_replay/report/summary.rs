...
impl ExperienceReplayReport {
    pub fn summary(&self) -> String {
        format!(
            ...
            self.average_reward,
            self.external_semantic_context_items,
            self.external_semantic_contexts,
            self.runtime_kv_budget_pressure_items,
            self.average_runtime_kv_budget_pressure,
            self.max_runtime_kv_budget_pressure,
            self.runtime_kv_weak_import_pressure_items,
            self.average_runtime_kv_weak_import_pressure,
            self.max_runtime_kv_weak_import_pressure,
