...
struct Args {
    ...
    benchmark_min_evolution_replay_live_memory_feedback_detail_items: Option<u64>,
    benchmark_min_evolution_replay_live_memory_feedback_applied: Option<u64>,
    benchmark_min_evolution_replay_live_memory_feedback_strength_delta: Option<f32>,
    benchmark_min_evolution_replay_live_evolution_items: Option<u64>,
    ...
    benchmark_min_evolution_replay_live_evolution_critical_reflection_issues: Option<u64>,
    ...
    benchmark_min_runtime_uncertainty_device_profiles: Option<usize>,
    benchmark_min_runtime_uncertainty_token_device_profiles: Option<usize>,
    ...
    benchmark_min_runtime_kv_stored_device_profiles: Option<usize>,
    ...
    inspect_max_runtime_adapter_selection_mismatches: Option<usize>,
    inspect_min_runtime_forward_energy_experiences: Option<usize>,
    inspect_min_runtime_kv_influence_experiences: Option<usize>,
    inspect_min_runtime_uncertainty_experiences: Option<usize>,
    inspect_min_runtime_uncertainty_tokens: Option<usize>,
    ...
    inspect_min_runtime_uncertainty_device_profiles: Option<usize>,
    inspect_min_runtime_uncertainty_token_device_profiles: Option<usize>,
    inspect_min_runtime_kv_precision_device_profiles: Option<usize>,
    inspect_min_runtime_device_execution_device_profiles: Option<usize>,
    ...
    inspect_min_evolution_live_online_reward_strength_device_profiles: Option<usize>,
    ...
    inspect_min_evolution_live_online_reward_strength: Option<f32>,
    inspect_min_evolution_live_online_reward_reinforcement_strength: Option<f32>,
    inspect_min_evolution_live_online_reward_penalty_strength: Option<f32>,
    ...
    inspect_min_evolution_replay_live_memory_feedback_detail_items: Option<u64>,
    ...
    inspect_min_evolution_replay_live_evolution_online_reward_strength: Option<f32>,
    inspect_min_evolution_replay_live_evolution_online_reward_reinforcement_strength: Option<f32>,
    inspect_min_evolution_replay_live_evolution_online_reward_penalty_strength: Option<f32>,
    ...
    inspect_min_evolution_replay_live_evolution_critical_reflection_issues: Option<u64>,
    inspect_min_evolution_replay_live_evolution_revision_actions: Option<u64>,
...
impl Args {
    ...
    fn parse(raw: Vec<String>) -> Self {
        ...
        let mut benchmark_min_evolution_replay_live_memory_feedback_detail_items = None;
        let mut benchmark_min_evolution_replay_live_memory_feedback_applied = None;
        let mut benchmark_min_evolution_replay_live_memory_feedback_strength_delta = None;
        let mut benchmark_min_evolution_replay_live_evolution_items = None;
        ...
        let mut benchmark_min_evolution_replay_live_evolution_critical_reflection_issues = None;
        ...
        let mut benchmark_min_runtime_uncertainty_device_profiles = None;
        let mut benchmark_min_runtime_uncertainty_token_device_profiles = None;
        ...
        let mut benchmark_min_runtime_kv_stored_device_profiles = None;
        ...
        let mut inspect_max_runtime_adapter_selection_mismatches = None;
        let mut inspect_min_runtime_forward_energy_experiences = None;
        let mut inspect_min_runtime_kv_influence_experiences = None;
        let mut inspect_min_runtime_uncertainty_experiences = None;
        let mut inspect_min_runtime_uncertainty_tokens = None;
        ...
        let mut inspect_min_runtime_uncertainty_device_profiles = None;
        let mut inspect_min_runtime_uncertainty_token_device_profiles = None;
        let mut inspect_min_runtime_kv_precision_device_profiles = None;
        let mut inspect_min_runtime_device_execution_device_profiles = None;
        ...
        let mut inspect_min_evolution_live_online_reward_strength_device_profiles = None;
        ...
        let mut inspect_min_evolution_replay_live_evolution_online_reward_strength_device_profiles =
            None;
        ...
        let mut inspect_min_evolution_live_online_reward_strength = None;
        let mut inspect_min_evolution_live_online_reward_reinforcement_strength = None;
        let mut inspect_min_evolution_live_online_reward_penalty_strength = None;
        ...
        let mut inspect_min_evolution_replay_live_memory_feedback_detail_items = None;
        ...
        let mut inspect_min_evolution_replay_live_evolution_online_reward_strength = None;
        let mut inspect_min_evolution_replay_live_evolution_online_reward_reinforcement_strength =
            None;
        let mut inspect_min_evolution_replay_live_evolution_online_reward_penalty_strength = None;
        ...
        let mut inspect_min_evolution_replay_live_evolution_critical_reflection_issues = None;
        let mut inspect_min_evolution_replay_live_evolution_revision_actions = None;
        ...
        while index < raw.len() {
            match raw[index].as_str() {
                ...
                "--benchmark-min-evolution-live-online-reward-reinforcements"
                    if index + 1 < raw.len() =>
                {
                ...
                "--benchmark-min-evolution-live-online-reward-penalties"
                    if index + 1 < raw.len() =>
                {
                ...
                "--benchmark-min-evolution-live-online-reward-device-profiles"
                    if index + 1 < raw.len() =>
                {
                ...
                "--benchmark-min-evolution-replay-live-memory-feedback-detail-items"
                    if index + 1 < raw.len() =>
                {
                    benchmark_min_evolution_replay_live_memory_feedback_detail_items =
                        Some(parse_u64(&raw[index + 1], 0));
                    benchmark_gate_enabled = true;
                    index += 2;
                }
                "--benchmark-min-evolution-replay-live-memory-feedback-applied"
                    if index + 1 < raw.len() =>
                {
                    benchmark_min_evolution_replay_live_memory_feedback_applied =
                        Some(parse_u64(&raw[index + 1], 0));
                    benchmark_gate_enabled = true;
                    index += 2;
                }
                "--benchmark-min-evolution-replay-live-memory-feedback-strength-delta"
                    if index + 1 < raw.len() =>
                {
                    benchmark_min_evolution_replay_live_memory_feedback_strength_delta =
                        Some(parse_f32(&raw[index + 1], 0.0));
                    benchmark_gate_enabled = true;
                    index += 2;
                }
                "--benchmark-min-evolution-replay-live-evolution-items"
                    if index + 1 < raw.len() =>
                {
                    benchmark_min_evolution_replay_live_evolution_items =
                        Some(parse_u64(&raw[index + 1], 0));
                    benchmark_gate_enabled = true;
                    index += 2;
                }
                ...
                "--benchmark-min-evolution-replay-live-evolution-critical-reflection-issues"
                    if index + 1 < raw.len() =>
                {
                    benchmark_min_evolution_replay_live_evolution_critical_reflection_issues =
                        Some(parse_u64(&raw[index + 1], 0));
                    benchmark_gate_enabled = true;
                    index += 2;
                }
                ...
                "--benchmark-min-runtime-uncertainty-device-profiles" if index + 1 < raw.len() => {
                    benchmark_min_runtime_uncertainty_device_profiles =
                        Some(parse_usize(&raw[index + 1], 0));
                    benchmark_gate_enabled = true;
                    benchmark_all_devices = true;
                    index += 2;
                }
                "--benchmark-min-runtime-uncertainty-token-device-profiles"
                    if index + 1 < raw.len() =>
                {
                    benchmark_min_runtime_uncertainty_token_device_profiles =
                        Some(parse_usize(&raw[index + 1], 0));
                    benchmark_gate_enabled = true;
                    benchmark_all_devices = true;
                    index += 2;
                ...
                "--benchmark-min-runtime-kv-stored-device-profiles" if index + 1 < raw.len() => {
                    benchmark_min_runtime_kv_stored_device_profiles =
                        Some(parse_usize(&raw[index + 1], 0));
                    benchmark_gate_enabled = true;
                    benchmark_all_devices = true;
                    index += 2;
                ...
                "--benchmark-min-runtime-embedding-cases" if index + 1 < raw.len() => {
                    benchmark_min_runtime_embedding_cases = Some(parse_usize(&raw[index + 1], 0));
                    benchmark_gate_enabled = true;
                    index += 2;
                }
                ...
                "--benchmark-min-runtime-device-execution-device-profiles"
                    if index + 1 < raw.len() =>
                {
                ...
                "--inspect-min-runtime-uncertainty-experiences" if index + 1 < raw.len() => {
                    inspect_min_runtime_uncertainty_experiences =
                        Some(parse_usize(&raw[index + 1], 0));
                    inspect_state = true;
                    inspect_gate = true;
                    index += 2;
                ...
                "--inspect-min-runtime-uncertainty-tokens" if index + 1 < raw.len() => {
                    inspect_min_runtime_uncertainty_tokens = Some(parse_usize(&raw[index + 1], 0));
                    inspect_state = true;
                    inspect_gate = true;
                    index += 2;
                }
                ...
                "--inspect-min-runtime-device-execution-device-profiles"
                    if index + 1 < raw.len() =>
                {
                ...
                "--inspect-min-evolution-live-online-reward-penalty-strength"
                    if index + 1 < raw.len() =>
                {
                ...
                "--inspect-min-evolution-replay-live-memory-feedback-applied"
                    if index + 1 < raw.len() =>
                {
                ...
                "--inspect-min-evolution-replay-live-evolution-memory-updates"
                    if index + 1 < raw.len() =>
                {
        ...
        Self {
            ...
            inspect_min_runtime_kv_influence_experiences,
            inspect_min_runtime_uncertainty_experiences,
            inspect_min_runtime_uncertainty_tokens,
            inspect_min_runtime_kv_precision_experiences,
            inspect_max_runtime_kv_precision_mismatches,
            inspect_min_runtime_device_execution_experiences,
            inspect_min_runtime_layer_mode_experiences,
...
fn print_help_and_exit() -> ! {
    let usage = concat!(
        ...
        "Inspect replay live evolution: --inspect-min-evolution-replay-live-evolution-items n --inspect-min-evolution-replay-live-evolution-online-reward-feedbacks n --inspect-min-evolution-replay-live-evolution-online-reward-reinforcements n --inspect-min-evolution-replay-live-evolution-online-reward-penalties n --inspect-min-evolution-replay-live-evolution-online-reward-strength f --inspect-min-evolution-replay-live-evolution-online-reward-reinforcement-strength f --inspect-min-evolution-replay-live-evolution-online-reward-penalty-strength f --inspect-min-evolution-replay-live-evolution-memory-updates n --inspect-min-evolution-replay-live-evolution-stored-memory-updates n --inspect-min-evolution-replay-live-evolution-reflection-issues n --inspect-min-evolution-replay-live-evolution-critical-reflection-issues n --inspect-min-evolution-replay-live-evolution-revision-actions n --inspect-min-evolution-replay-live-evolution-device-profiles n --inspect-min-evolution-replay-live-evolution-online-reward-device-profiles n --inspect-min-evolution-replay-live-evolution-online-reward-strength-device-profiles n --inspect-min-evolution-replay-live-evolution-memory-update-device-profiles n --inspect-min-evolution-replay-live-evolution-critical-reflection-issue-device-profiles n --inspect-min-evolution-replay-live-evolution-revision-action-device-profiles n\n",
        "Inspect live evolution: --inspect-min-evolution-live-inference-runs n --inspect-min-evolution-live-router-threshold-mutations n --inspect-min-evolution-live-hierarchy-weight-mutations n --inspect-min-evolution-live-router-threshold-delta f --inspect-min-evolution-live-hierarchy-weight-delta f --inspect-min-evolution-live-online-reward-feedbacks n --inspect-min-evolution-live-online-reward-reinforcements n --inspect-min-evolution-live-online-reward-penalties n --inspect-min-evolution-live-online-reward-strength f --inspect-min-evolution-live-online-reward-reinforcement-strength f --inspect-min-evolution-live-online-reward-penalty-strength f --inspect-min-evolution-live-memory-updates n --inspect-min-evolution-live-stored-memory-updates n --inspect-min-evolution-live-reflection-issues n --inspect-min-evolution-live-critical-reflection-issues n --inspect-min-evolution-live-revision-actions n\n",
        "Inspect all-device live evolution: --inspect-min-evolution-live-inference-device-profiles n --inspect-min-evolution-live-router-threshold-mutation-device-profiles n --inspect-min-evolution-live-hierarchy-weight-mutation-device-profiles n --inspect-min-evolution-live-online-reward-device-profiles n --inspect-min-evolution-live-online-reward-strength-device-profiles n --inspect-min-evolution-live-memory-update-device-profiles n --inspect-min-evolution-live-stored-memory-update-device-profiles n --inspect-min-evolution-live-reflection-issue-device-profiles n --inspect-min-evolution-live-critical-reflection-issue-device-profiles n --inspect-min-evolution-live-revision-action-device-profiles n\n",
