...
\begin{enumerate}[leftmargin=*]
  ...
  \item State the license boundary clearly. The paper and repository should
  both describe the current GPL-3.0 terms so readers do not confuse historical
  policy with the controlling license.
\end{enumerate}
