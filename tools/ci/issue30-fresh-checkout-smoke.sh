...
"${cargo_cmd[@]}" run --locked --package norion-cli -- evidence-packet \
  ...
  --require 'issue4_dna_candidate_ledger_packet_proof=true' \
  --require 'issue4_dna_candidate_ledger_records=1' \
  --require 'issue4_dna_candidate_ledger_candidate_count=1' \
  --require 'issue4_dna_candidate_ledger_candidate_only=true' \
  --require 'issue4_dna_candidate_ledger_digest=redaction-digest:' \
  --require 'issue4_dna_candidate_ledger_write_allowed=false' \
  --require 'issue4_dna_candidate_ledger_applied=false' \
  ...
  --require 'issue377_problem_finding_present=true' \
  --require 'issue377_problem_finding_id=redaction-digest:' \
  --require 'issue377_problem_finding_kind=wasted_compute' \
  --require 'issue377_problem_finding_severity=medium' \
  --require 'issue377_problem_finding_confidence_milli=850' \
  --require 'issue377_problem_finding_evidence_digest=redaction-digest:' \
  --require 'issue377_problem_finding_source_digest=redaction-digest:' \
  --require 'issue377_problem_finding_affected_surface=runtime_kv_reuse' \
  --require 'issue377_problem_finding_next_step=experiment' \
  --require 'issue377_problem_finding_raw_payload_present=false' \
  --require 'issue377_hypothesis_candidate_present=true' \
  --require 'issue377_hypothesis_candidate_id=redaction-digest:' \
  --require 'issue377_problem_hypothesis_link=redaction-digest:' \
  --require 'issue377_admission_decision=preview_only' \
  --require 'issue377_lexicographic_admission_present=true' \
  --require 'issue377_lexicographic_admission_order=user_intent_preservation>safety>digest_only_evidence>rollback_anchor>quality_delta>cost_delta>latency_delta' \
  --require 'issue377_user_intent_preserved=true' \
  --require 'issue377_safety_gate_passed=true' \
  --require 'issue377_digest_only_evidence_gate_passed=true' \
  --require 'issue377_rollback_anchor_gate_passed=true' \
  --require 'issue377_quality_delta_milli=125' \
  --require 'issue377_cost_delta_milli=-80' \
  --require 'issue377_latency_delta_milli=-35' \
  --require 'issue377_performance_tiebreaker_only=true' \
  --require 'issue377_hard_gate_failure_action=hold' \
  --require 'issue377_risk_override_action=hold' \
  --require 'issue377_negative_evidence_count=0' \
  --require 'issue377_privacy_risk=low' \
  --require 'issue377_license_risk=low' \
  --require 'issue377_unsupported_capability_requested=false' \
  --require 'issue377_unsafe_side_effect_allowed=false' \
  --require 'issue377_risk_override_clear=true' \
  --require 'issue377_lexicographic_admission_apply_allowed=false' \
  --require 'issue377_best_next_state=problem_finding_preview' \
  --require 'issue377_best_next_state_id=redaction-digest:' \
  --require 'issue377_best_next_state_selected=true' \
  ...
  --require 'issue377_experiment_plan_present=true' \
  --require 'issue377_experiment_plan_id=redaction-digest:' \
  --require 'issue377_experiment_plan_mode=preview_only' \
  --require 'issue377_evidence_bundle_present=true' \
  --require 'issue377_evidence_bundle_id=redaction-digest:' \
  --require 'issue377_evidence_bundle_refs_digest_only=true' \
  --require 'issue377_experiment_decision=promote_for_approval' \
  --require 'issue377_experiment_runner_allowed=false' \
  --require 'issue377_experiment_apply_allowed=false' \
  --require 'issue377_mutation_candidate_emitter_present=true' \
  --require 'issue377_mutation_candidate_emitter_id=redaction-digest:' \
  --require 'issue377_mutation_candidate_id=redaction-digest:' \
  --require 'issue377_mutation_candidate_evidence_digest=redaction-digest:' \
  --require 'issue377_mutation_candidate_rollback_anchor=redaction-digest:' \
  --require 'issue377_mutation_candidate_requested_write_scope=reasoning_genome_preview' \
  --require 'issue377_mutation_candidate_kind=mutation_plan_preview' \
  --require 'issue377_mutation_candidate_preview_only=true' \
  --require 'issue377_mutation_candidate_refs_digest_only=true' \
  --require 'issue377_mutation_candidate_writer_gate_preflight=hold' \
  --require 'issue377_mutation_candidate_write_allowed=false' \
  --require 'issue377_mutation_candidate_applied=false' \
  --require 'issue377_mutation_candidate_apply_allowed=false' \
  --require 'issue377_mutation_candidate_manual_review_required=true' \
  --require 'issue377_manual_approval_binding_present=true' \
  --require 'issue377_manual_approval_candidate_id=redaction-digest:' \
  --require 'issue377_manual_approval_evidence_digest=redaction-digest:' \
  --require 'issue377_manual_approval_rollback_anchor=redaction-digest:' \
  --require 'issue377_manual_approval_requested_write_scope=reasoning_genome_preview' \
  --require 'issue377_manual_approval_ref=redaction-digest:' \
  --require 'issue377_manual_approval_expiration=1970-01-01T00:00:00Z' \
  --require 'issue377_manual_approval_apply_allowed=false' \
  --require 'issue377_manual_approval_applied=false' \
  --require 'persistent_roundtrip: passed=true' \
  --require 'issue30_disk_kv_roundtrip_ready=true' \
