...
"${cargo_cmd[@]}" run --locked --package norion-cli -- evidence-packet \
  ...
  --require 'issue375_reasoning_frame_allowed_observations=repo_issue_terminal_runtime_state_task_constraints_memory_state_runtime_health' \
  --require 'issue375_reasoning_frame_action_vocab=observe_inspect_compare_summarize_propose_simulate_gate_verify_quarantine_rollback' \
  --require 'issue375_reasoning_frame_executed_opcodes=bind_stimulus_load_gene_match_env_express_trait_set_budget_select_memory_pack_context_focus_signal_mask_signal_declare_action_vocab_suppress_capability_require_evidence_declare_gate_preview_mutation_emit_frame' \
  --require 'issue375_reasoning_frame_routing_bias=general:low:520:1' \
  --require 'issue375_reasoning_frame_memory_policy=digest_only_profile_memory:semantic-gist-experience:4' \
  --require 'issue375_reasoning_frame_mutation_previews=0' \
  --require 'issue375_reasoning_frame_suppressed_capabilities=write_shell_browser_network_process_file_write_memory_write_genome_write_issue_pr_write_runtime_write' \
  ...
  --require 'issue377_self_observation_present=true' \
  --require 'issue377_self_observation_id=redaction-digest:' \
  --require 'issue377_self_observation_schema=self_observation_v1' \
  --require 'issue377_self_observation_signal_source=runtime_trace_metrics' \
  --require 'issue377_self_observation_source_digest=redaction-digest:' \
  --require 'issue377_self_observation_window=second_task_roundtrip' \
  --require 'issue377_self_observation_current_truth_digest=redaction-digest:' \
  --require 'issue377_self_observation_digest_only=true' \
  --require 'issue377_self_observation_raw_payload_present=false' \
  --require 'issue377_self_observation_write_allowed=false' \
  --require 'issue377_self_observation_applied=false' \
  --require 'issue377_self_model_present=true' \
  --require 'issue377_self_model_id=redaction-digest:' \
  --require 'issue377_self_model_schema=control_plane_self_model_v1' \
  --require 'issue377_self_model_scope=auditable_control_plane' \
  --require 'issue377_self_model_claims_consciousness=false' \
  --require 'issue377_self_model_digest_only=true' \
  --require 'issue377_self_model_raw_payload_present=false' \
  --require 'issue377_self_model_write_allowed=false' \
  --require 'issue377_self_model_applied=false' \
  --require 'issue377_hypothesis_candidate_present=true' \
  --require 'issue377_hypothesis_candidate_id=redaction-digest:' \
  --require 'issue377_hypothesis_candidate_kind=gene' \
  --require 'issue377_hypothesis_candidate_status=promoted_for_approval' \
  --require 'issue377_hypothesis_candidate_target_surface=reasoning_gene' \
  --require 'issue377_hypothesis_candidate_expected_metric=memory_reuse' \
  --require 'issue377_hypothesis_candidate_expected_direction=increase' \
  --require 'issue377_hypothesis_candidate_required_gates=trace_schema_gate|focused_tests|benchmark_gate' \
  --require 'issue377_hypothesis_candidate_rollback_anchor=redaction-digest:' \
  --require 'issue377_hypothesis_candidate_raw_payload_present=false' \
  --require 'issue377_hypothesis_candidate_write_allowed=false' \
  --require 'issue377_hypothesis_candidate_applied=false' \
  --require 'issue377_hypothesis_candidate_operator_approval_required=true' \
  ...
  --require 'issue377_experiment_plan_level_path=L0_schema_safety|L1_focused_validation|L3_benchmark' \
  --require 'issue377_validation_skipped_levels=L2_replay|L4_integration_readiness|L5_promotion_window' \
  --require 'issue377_validation_skipped_reason=minimal_existing_evidence_path' \
  --require 'issue377_human_apply_level=L6_human_apply' \
  --require 'issue377_human_apply_inside_engine=false' \
  --require 'issue377_validation_level_apply_allowed=false' \
  --require 'issue377_experiment_plan_required_gates=trace_schema_gate|focused_tests|benchmark_gate' \
  --require 'issue377_experiment_plan_budget_tokens=2048' \
  --require 'issue377_experiment_plan_stop_on_fail=true' \
  --require 'issue377_experiment_plan_rollback_anchor=redaction-digest:' \
  --require 'issue377_experiment_plan_raw_payload_present=false' \
  --require 'issue377_experiment_plan_write_allowed=false' \
  --require 'issue377_experiment_plan_applied=false' \
  --require 'issue377_evidence_bundle_present=true' \
  --require 'issue377_evidence_bundle_id=redaction-digest:' \
  --require 'issue377_evidence_bundle_schema=evidence_bundle_v1' \
  --require 'issue377_evidence_bundle_metric=memory_reuse' \
  --require 'issue377_evidence_bundle_direction=increase' \
  --require 'issue377_evidence_bundle_pass_count=3' \
  --require 'issue377_evidence_bundle_fail_count=0' \
  --require 'issue377_evidence_bundle_command_label=issue30_fresh_checkout_smoke' \
  --require 'issue377_evidence_bundle_refs_digest_only=true' \
  --require 'issue377_evidence_bundle_raw_payload_present=false' \
  --require 'issue377_evidence_bundle_write_allowed=false' \
  --require 'issue377_evidence_bundle_applied=false' \
  --require 'issue377_experiment_decision=promote_for_approval' \
  --require 'issue377_experiment_decision_schema=experiment_decision_v1' \
  --require 'issue377_experiment_decision_reason=clean_evidence_bundle_promotes_preview' \
  --require 'issue377_experiment_decision_evidence_bundle_id=redaction-digest:' \
  --require 'issue377_experiment_decision_target=mutation_candidate_emitter' \
  --require 'issue377_experiment_decision_manual_approval_required=true' \
  --require 'issue377_experiment_decision_apply_allowed=false' \
  ...
  --require 'issue377_candidate_emitter_lane_coverage=reasoning_genome_preview|memory_admission_preview|routing_policy_preview|tool_policy_preview|evolution_goal_preview' \
  --require 'issue377_candidate_emitter_kind_coverage=mutation_plan_preview|memory_admission_preview|routing_shadow_proposal|tool_policy_candidate|evolution_goal_preview' \
  --require 'issue377_candidate_emitter_coverage_count=5' \
  --require 'issue377_candidate_emitter_all_preview_only=true' \
  --require 'issue377_candidate_emitter_all_write_allowed=false' \
  --require 'issue377_candidate_emitter_all_apply_allowed=false' \
  --require 'issue377_candidate_emitter_all_manual_review_required=true' \
  --require 'issue377_candidate_emitter_durable_preflight_owner=unified_writer_gate' \
  --require 'issue377_candidate_emitter_writer_gate_bypass_allowed=false' \
  --require 'issue377_candidate_emitter_direct_durable_write_allowed=false' \
  --require 'issue377_candidate_emitter_ready_for_explicit_apply=false' \
  --require 'issue377_related_issue_refs=#6|#7|#74|#79|#375' \
  --require 'issue377_related_issue_scope_map=#6:experiment_gates|#7:memory_admission_pipeline|#74:thinking_scheduler|#79:evolution_goal_queue|#375:pre_reasoning_genome_isa' \
  --require 'issue377_related_issue_owner_scope=meta_cognitive_evolution_loop' \
  --require 'issue377_related_issue_non_duplicate_count=5' \
  --require 'issue377_related_issue_all_non_duplicate=true' \
  --require 'issue377_related_issue_apply_allowed=false' \
  --require 'issue377_clean_room_reference_mode=rust_norion_terms_only' \
  --require 'issue377_external_code_copied=false' \
  --require 'issue377_external_prompt_or_schema_copied=false' \
  --require 'issue377_restricted_license_material_copied=false' \
  --require 'issue377_license_provenance_posture=project_owned_digest_only' \
  --require 'issue377_clean_room_apply_allowed=false' \
