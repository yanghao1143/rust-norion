...
grep -E 'issue30_fresh_checkout_smoke=passed|release_review_ready=true|issue30_second_task_benefit_ready=true|issue30_negative_gates_ready=true|disk_kv_compact_reopen_verified=true|memory_admission_ledger_reopen_verified=true|memory_admission_authorized_fixture_apply_verified=true|issue2_memory_admission_preview_apply_proof=true|issue2_memory_authorized_fixture_apply_proof=true|issue2_memory_ledger_apply_proof=true|issue30_memory_ledger_trace_ready=true|issue30_trace_validation_ready=true|issue30_state_inspection_ready=true|issue2_state_files_ndkv_proof=true|issue2_ndkv_non_fixture_write_proof=true' "$packet"
