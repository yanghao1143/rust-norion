...
Assert-Contains -Name "read_only_check_only" -Text $readOnlyText -Pattern "--memory"
Assert-Contains -Name "read_only_check_only" -Text $readOnlyText -Pattern "--adaptive"
...
Assert-Contains -Name "apply_check_only_plans_reload" -Text $applyText -Pattern "stop_command:"
