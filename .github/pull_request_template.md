...
- [ ] `cargo test` or focused equivalent passed
- [ ] Formatting/check command passed, when applicable
- [ ] Trace or benchmark evidence updated for routing, memory, genome, runtime, task hierarchy, or self-evolution changes
- [ ] No `.ndkv`, model weights, credentials, generated `target` files, logs, or private data included
